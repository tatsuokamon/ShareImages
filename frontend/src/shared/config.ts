export const Config = {
	...
	ban_dom_id: "ban_list",
	default_name: "無名",
	room_endpoint: function(keyword: string) {return `${this.host}room?keyword=${keyword}`},
	master_endpoint: function(keyword: string) {return `${this.host}admin?keyword=${keyword}`},
	timeout: 5,
	max_content: 140,
